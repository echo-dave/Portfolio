...
$(document).ready(function () {
    ...
    let bamazon = ["Bamazon", "Bamazon is a webstore front utilizing NodeJS and ExpressJS for webserver / routing and backend logic. Sequelize with MySQL handle the various database requests for display, update, and creating products. jQuery and Bulma sass are utilized for building and manipulating the frontend dynamically."]
